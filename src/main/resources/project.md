...
3. transactions.csv : Το πεδίο transactionId είναι μοναδικό για την κάθε εγγραφή.
#### Να υλοποιήσετε τις παρακάτω REST διεπαφές με τις εξής προδιαγραφές:
1. Ανάκτηση στοιχείων δικαιούχου. DONE!
2. Ανάκτηση των λογαριασμών ενός δικαιούχου.DONE!
3. Ανάκτηση των συναλλαγών ενός δικαιούχου.DONE!
4. Ανάκτηση υπολοίπου των λογαριασμών ενός ανθρώπου.DONE!
